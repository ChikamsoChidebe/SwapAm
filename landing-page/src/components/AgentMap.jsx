  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6">
      ...
      <div className="relative bg-gradient-to-br from-green-50 to-blue-50 rounded-lg h-64 sm:h-80 mb-6 overflow-hidden">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.952912260219!2d3.3870225!3d6.5158037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8b2ae68280c1%3A0xdc692ba70413d8e5!2sUniversity%20of%20Lagos!5e0!3m2!1sen!2sng!4v1703123456789!5m2!1sen!2sng"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
        ...
        {agents.map((agent, index) => (
          <div
            key={agent.id}
            className={`absolute w-8 h-8 rounded-full border-2 border-white shadow-lg cursor-pointer transform transition-transform hover:scale-110 z-10 ${
